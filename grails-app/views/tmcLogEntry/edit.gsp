    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <input type="hidden" name="version" value="${tmcLogEntryInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:tmcLogEntryInstance,field:'sections','errors')}">
                                    <g:select name="sections"
from="${edu.uci.its.tmcpe.Section.list()}"
size="5" multiple="yes" optionKey="id"
value="${tmcLogEntryInstance?.sections}" />
