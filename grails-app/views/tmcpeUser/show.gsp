...
<body>
	...
	<div class="nav">
		...
		<span class="menuButton"><g:link class="list" action="list">TmcpeUser List</g:link></span>
		<span class="menuButton"><g:link class="create" action="create">New TmcpeUser</g:link></span>
	</div>

	<div class="body">
		<h1>Show TmcpeUser</h1>
