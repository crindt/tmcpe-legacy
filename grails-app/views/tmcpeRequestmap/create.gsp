<head>
	...
	<title>Create TmcpeRequestmap</title>
</head>
...
<body>
	...
	<div class="nav">
		...
		<span class="menuButton"><g:link class="list" action="list">TmcpeRequestmap List</g:link></span>
	</div>

	<div class="body">
		<h1>Create TmcpeRequestmap</h1>
		...
		<g:form action="save">
			<div class="dialog">
				...
				<tbody>
					...
					<tr class="prop">
						<td valign="top" class="name"><label for="configAttribute">TmcpeRole (comma-delimited):</label></td>
