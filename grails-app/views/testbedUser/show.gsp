...
<body>
	...
	<div class="nav">
		...
		<span class="menuButton"><g:link class="list" action="list">TestbedUser List</g:link></span>
		<span class="menuButton"><g:link class="create" action="create">New TestbedUser</g:link></span>
	</div>

	<div class="body">
		<h1>Show TestbedUser</h1>
