...
<body>
	...
	<div class="nav">
		...
		<span class="menuButton"><g:link class="list" action="list">TmcpeRole List</g:link></span>
		<span class="menuButton"><g:link class="create" action="create">New TmcpeRole</g:link></span>
	</div>

	<div class="body">
		<h1>Edit TmcpeRole</h1>
		...
		<g:form>
			...
			<tbody>
				<tr class="prop">
					<td valign="top" class="name"><label for="authority">TmcpeRole Name:</label></td>
