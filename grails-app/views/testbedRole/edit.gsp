...
<body>
	...
	<div class="nav">
		...
		<span class="menuButton"><g:link class="list" action="list">TestbedRole List</g:link></span>
		<span class="menuButton"><g:link class="create" action="create">New TestbedRole</g:link></span>
	</div>

	<div class="body">
		<h1>Edit TestbedRole</h1>
		...
		<g:form>
			...
			<tbody>
				<tr class="prop">
					<td valign="top" class="name"><label for="authority">TestbedRole Name:</label></td>
