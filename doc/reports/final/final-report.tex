...
\fixme{crindt}{Discuss the main features: query screen and its parameters, map
  view, time-space diagram view, etc.}
...
for vehicles traveling under \fixme[$35\unitfrac{mi}{h}$]{crindt}{refer to the
  original equation}.  By definition, this method implies there is no delay if
...
will attribute lower delays to an incident than the \fixme[$D_{35}$
method]{crindt}{define} for the same time-space region.
...
the original method.  \fixme{crindt}{Elaborate here by pulling stats}
...
\fixme[]{crindt}{Flesh these out; ties to section~\ref{sec:intro}.}
