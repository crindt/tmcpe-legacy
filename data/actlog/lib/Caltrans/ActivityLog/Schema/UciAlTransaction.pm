package Caltrans::ActivityLog::Schema::UciAlTransaction;
...
__PACKAGE__->table("UCI_AL_Transaction");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:655aq9066MZGHeuYIjaJgg
