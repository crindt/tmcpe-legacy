package Caltrans::ActivityLog::Schema::CommRlTransaction;
...
__PACKAGE__->table("Comm_RL_Transaction");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Hq51rtZSEwr+4m4DGztXkg
