package Caltrans::ActivityLog::Schema::CommRlBackup2010;
...
__PACKAGE__->table("Comm_RL_BackUp_2010");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:XID6MVVI0GIW/kXcMYEgcw
