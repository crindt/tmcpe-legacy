package Caltrans::ActivityLog::Schema::CtAlTransaction;
...
__PACKAGE__->table("CT_AL_Transaction");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:EwiEK4HIKPnMkofv3dvJWQ
